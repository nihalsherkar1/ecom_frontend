...
import { setAuthenticated, setError } from "../../features/Auth/Regisiter";
import { loginUser } from "../../features/Auth/RegisterAction";
    ...
    <div className="mt-8">
      ...
      <form onSubmit={handleSubmit}>
        <div className="flex flex-col items-center justify-center   px-6 py-8 mx-auto lg:py-0">
          <div className="w-full bg-white rounded-lg shadow-lg border border-gray-300 md:mt-0 sm:max-w-md xl:p-0">
            <div className="p-6 space-y-4 md:space-y-6 sm:p-8">
              ...
              <span className="text-blue-500"> If you have new </span>
